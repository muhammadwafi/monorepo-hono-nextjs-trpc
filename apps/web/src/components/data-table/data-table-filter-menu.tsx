		...
		return (
			...
			>
				<Popover open={showFieldSelector} onOpenChange={setShowFieldSelector}>
					<PopoverTrigger asChild>
						<Button
							variant="ghost"
							size="sm"
							className="rounded-none rounded-l-sm border border-r-0 font-normal dark:bg-input/30"
						>
							{columnMeta?.icon && (
				...
				<Button
					...
					variant="ghost"
					size="sm"
					className="h-full rounded-none rounded-r-sm border border-l-0 px-1.5 font-normal dark:bg-input/30"
